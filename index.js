const contentLetterSrart_actived = "Chúc bạn sinh nhật vui vẻ, hạnh phúc và nhận được nhiều quà nhé." //Lời mở đầu cho bức thư
const mainContentLetter = "Ơ, ko biết nói gì, thôi chúc bạn sớm có chồng he." //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "./img/trammap.jpg";

// Gắn 1 link ảnh bất kì
let imgLetter = document.querySelector(".img");
imgLetter.src = "./img/tramom.jpg"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
